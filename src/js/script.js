...
// while - diferente do for, no while não sabemos a 
// quantidade de vezes que o código vai executar
...
// declaração de variável undefined
// let numero;

// while(numero !== "0"){
//     numero = prompt("Digite algo (ou 0 para sair)");
